# Lista de tareas con react-native
## English
...
The "first" CRUD with react-native (Although it is not finished yet, it is expected to be completed in future versions)

#### 🤔 The problem

Create a task and/or contact list for mobile devices...
